...
```
git clone https://github.com/AFakhriddinov/Bookstore.git
```
...
git clone git https://github.com/AFakhriddinov/Bookstore.git
...
This project is [MIT](https://github.com/AFakhriddinov/Bookstore/blob/development/LICENSE) licensed.
